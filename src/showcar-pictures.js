(function (window, document) {
  ...
  const merge = (src1, src2) => Object.assign({}, src1, src2);
  ...
  class Pictures {
    ...
    attached () {
      ...
      document.addEventListener('keydown', e => this._fullScreenKeyboardHandler(e));

      // Slider
      this.slider = this.element.querySelector('[role=slider]');
      if (this.slider) {
        this._addSlider();
        this.fullScreenOpenListener = this._fullScreenOpenHandler.bind(this);
      ...
      if (this.thumbnails) this._initThumbnails();

      this.fullScreenCloseListener = this._fullScreenCloseHandler.bind(this);
        ...
        prototype: Object.assign(
          Object.create(HTMLElement.prototype, {
            ...
            removeSlide (slideIndex) {
              this.pictures._removeSlide(slideIndex);
            }
          }
        )
      });
